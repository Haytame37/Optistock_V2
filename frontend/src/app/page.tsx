...
import { ArrowRight, MapPin, Package, Search, ShieldCheck, TrendingUp, Database, Thermometer, ChevronRight } from "lucide-react"
...
function WaveSep({dark=true,flipY=false}:{dark?:boolean,flipY?:boolean}){return(
      ...
      <main>
        ...
        <section className="relative h-[85vh] flex items-center overflow-hidden">
          <div className="absolute inset-0 z-0">
             <img src="/modern_smart_warehouse_dashboard_1778782292438.png" alt="Warehouse" className="w-full h-full object-cover" />
        ...
        <section id="services" className="py-24 bg-slate-50 dark:bg-slate-900/50 scroll-mt-20">
          <div className="mx-auto max-w-7xl px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <motion.div {...(rm?{}:{whileHover:{y:-6}})} transition={{type:"spring",stiffness:300,damping:20}} className="group backdrop-blur-sm bg-white dark:bg-slate-900 p-10 border border-slate-200/60 dark:border-white/10 shadow-sm hover:shadow-2xl hover:shadow-blue-500/20 hover:border-blue-400/40 transition-all">
      ...
      <footer className="bg-slate-950 text-slate-400 py-12 border-t border-white/10">
        <div className="mx-auto max-w-7xl px-6 flex flex-col items-center gap-6 text-center">
          ...
          <div className="border-t border-white/10 w-full pt-6 space-y-1">
            <p className="text-[10px] font-bold uppercase tracking-[0.5em]">© 2025 OptiStock Solutions — ENSA Béni Mellal, TDI</p>
            <p className="text-[10px] font-bold uppercase tracking-[0.5em] opacity-50">© 2026 OptiStock · Industrial Logistics Engineering</p>
          </div>
        </div>
      </footer>
    </div>
